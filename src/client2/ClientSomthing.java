        ...
        public void run() {
            ...
            try {
                while (true) {
                   ...
                   client2.Controller.setStrin(str);
                   Controller.writeMsgText(str);
                 //   synchronizedBlockGet();
//                  synchronized (Main.myControllerHandle){
//                      Main.myControllerHandle.field_msg.appendText("b bb bk jjk");
//                  };
//                    Platform.runLater(()->{
//                            Main.myControllerHandle.field_msg.appendText(str);
//                    });
                }
            } catch (IOException e) {
                ClientSomthing.this.downService();
...
//        synchronized( Main.myControllerHandle ) {
//            Main.myControllerHandle.field_msg.appendText("n  nj nj n nj");
//        }
//    }
}